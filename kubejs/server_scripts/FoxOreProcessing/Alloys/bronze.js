...
ServerEvents.recipes(event => {
	...
	let enablingMods = ['alltheores', 'immersiveengineering', 'mekanism'];
	...
	let addRecipes = function(event) {
		...
		namespace.Molten.AddMixingRecipe(event, [{ 'tag': 'forge:ingots/copper', 'count': 3}, '#forge:ingots/tin'], data.moltenFluid, 360);
		namespace.Molten.AddMixingRecipe(event, [{ 'tag': 'forge:dusts/copper', 'count': 3}, '#forge:dusts/tin'], data.moltenFluid, 360);
		// Add Molten Mixing Recipes - Crushed
		namespace.Molten.AddMixingRecipe(event, [{ 'item': 'create:crushed_raw_copper', 'count': 3}, 'create:crushed_raw_tin'], data.moltenFluid, 720);
	}
