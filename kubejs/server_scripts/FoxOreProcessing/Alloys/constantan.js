...
ServerEvents.recipes(event => {
	...
	let addRecipes = function(event) {
		...
		namespace.Molten.AddMixingRecipe(event, ['#forge:ingots/copper', '#forge:ingots/nickel'], data.moltenFluid, 180);
		namespace.Molten.AddMixingRecipe(event, ['#forge:dusts/copper', '#forge:dusts/nickel'], data.moltenFluid, 180);
		// Add Molten Mixing Recipes - Crushed
		namespace.Molten.AddMixingRecipe(event, ['create:crushed_raw_copper', 'create:crushed_raw_nickel'], data.moltenFluid, 360);
	}
